...
public class Notification extends CordovaPlugin {
    ...
    public synchronized void prompt(final String message, final String title, final JSONArray buttonLabels, final String defaultText, final CallbackContext callbackContext) {
        ...
        Runnable runnable = new Runnable() {
            public void run() {
                ...
                int promptInputTextColor = ContextCompat.getColor(cordova.getContext(), MainActivity.dialog_input_text_color);
    ...
    private Builder createDialog(CordovaInterface cordova) {
        ...
        if (currentapiVersion >= android.os.Build.VERSION_CODES.HONEYCOMB) {
            ...
            return new Builder(cordova.getActivity(), MainActivity.dialog_theme);
        } else {
