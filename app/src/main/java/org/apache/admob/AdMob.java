...
import org.apache.admob.banner.BannerExecutor;
import org.apache.admob.interstitial.InterstitialExecutor;
import org.apache.admob.rewardvideo.RewardVideoExecutor;
...
public class AdMob extends CordovaPlugin {
    ...
    public AdRequest buildAdRequest() {
        int isForChildren = MainActivity.game_for_children;
        RequestConfiguration conf= new RequestConfiguration.Builder()
                .setTagForChildDirectedTreatment(isForChildren).build();
